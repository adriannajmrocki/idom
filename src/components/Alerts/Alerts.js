...
export class Alerts extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (message !== prevProps.message) {
      ...
      if (message.ipSet) alert.success(t('messages.ipSet'));
      if (message.ipError) alert.error(t('messages.ipError'));
      if (message.controllerOfflineError) alert.error(t('messages.controllerOfflineError'));
      ...
      if (message.actionUpdated) alert.success(t('messages.actionUpdated'));
      ...
      if (message.emptyFieldsError) alert.error(t('messages.emptyFieldsError'));
      if (message.invalidData) alert.error(t('messages.invalidData'));
      if (message.actionExistsError) alert.error(t('messages.actionExistsError'));
    }
  }
